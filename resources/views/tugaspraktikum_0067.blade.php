  ...
  <body>
    <nav class="navbar navbar-light bg-success">
        <a class="navbar-brand" href="#">
            <h2><img src="{{ URL::asset('teknik.jpg') }}" width="45" height="45" class="d-inline-block align-top" alt=""> tugas kegiatan 4</h2>
        </a>
    </nav>		
    <div class="container" style="margin-top: 10px;">
        <div class="row">   
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header bg-success"><b><i class="fa fa-list"></i> DAFTAR DOKTER</b></div>
                    <div class="card-body">
